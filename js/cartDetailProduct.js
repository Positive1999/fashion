...
function renderCartItems() {
  ...
  if (products && products.length > 0) {
    products.forEach(function (product, index) {
      ...
      infoProduct.appendChild(productSize);
...
function notifyShop() {
  ...
  var subject = "THÔNG TIN ĐƠN HÀNG";

  var selectedProducts = document.querySelectorAll('.productItem h5');
  var productNames = Array.from(selectedProducts).map(function(product) {
